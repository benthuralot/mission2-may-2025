export const errorMessages = {
  MISSING_INPUT: "there is an error: cannot leave blank",
  INVALID_DATA_TYPE: "there is an error: the input must be a number",
  NEGATIVE_INPUT: "there is an error: input cannot be negative",
